          ...
          <div class="form-group">
            ...
            <div class="col-md-7">
               <form action="shenhe.do.php?do=changeconfig&cof=black_word" method="post"> 
                   <textarea class="form-control" rows="4" name="name"><?=$xuanzezu[26]?></textarea>
                   <button class="btn btn-primary btn-block" style="margin-top:5px" type="submit" >修改</button>
        		 </form> 
           	</div>
           </div>
                 <div class="alert alert-warning">
                ...
                foreach($plugs as $plugin){
                   ...
                   // echo $qdq;
                    ...
                    if($plugin['needword']){
                        echo '
                        <div class="form-group">
            <label class="control-label col-md-3">'.$plugin['title'].'触发词:</label>
            <div class="col-md-8">
               <form action="shenhe.do.php?do=plugsconf&cof='.$plugin['name'].'" method="post" id="validate-form"> 
               <div class="input-group">
                <input class="form-control" ';
                 ...
                 echo ' value="'.$plugin['keyword'].'" name="name" type="text"/><span class="input-group-btn"><button class="btn btn-success" type="submit">修改</button></span>
                 </div>
        		 </form> 
                   </div>
                   </div>
