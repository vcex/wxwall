                ...
                <table class="table table-bordered table-striped" id="datatable-editable">
				 ...
				 ?>
                    ...
                    <tr name="<?=$q[0]?>">
                      ...
                      <td class="actions">
                          <a class="edit-row" href="javascript:void(0)"><i class="icon-pencil"></i></a><a class="dete-row" href="shenhe.do.php?do=zengjian&cid=2&numdel=<?=$q[0]?>"><i class="icon-trash"></i></a>
                      </td>
                    </tr>
			<?php $i++; }?>
                  </tbody>
