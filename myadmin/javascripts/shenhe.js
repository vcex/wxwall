$(function(){
		...
		$('.plug-switch').on('switch-change', function (e, data) {
			var $el = $(data.el), value = data.value;
		   if(value){
			   $.get("shenhe.do.php", {do: "plugswitch",switchname:$el[0].name,cid: "1" },function(){
				   });
			   }else{
			   $.get("shenhe.do.php", {do: "plugswitch",switchname:$el[0].name,cid: "0"},function(){
				   });
				   }
		});
